            ...
            <div class="formarea container">
                {!! Form::open(['route' => ['gifts.update', 'gift' => $gift->id],'method'=>'put']) !!}
                    <div class="form-group">
                        ...
                        {!! Form::textarea('gift', old('gift',$gift->gift), ['class' => 'form-control col-md-9', 'rows' => '1']) !!}
                        </div>
                        <div class="row my-3">
                        <label for="day" class="col-md-3 col-form-label">贈った日：</label>
                        {!! Form::date('day', old('day',$gift->day), ['class' => 'form-control col-md-9', 'rows' => '1']) !!}
                        </div>
                        <div class="row my-3">
                        ...
                        {!! Form::textarea('explain', old('explain',$gift->explain), ['class' => 'form-control col-md-9', 'rows' => '3']) !!}
                        </div>
                    </div>
                        <div class="col-12">
